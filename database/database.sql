...
INSERT INTO `asignatura` (`id_asig`, `nombre`, `creditos`) VALUES (NULL, 'Defensa Contra las Artes Oscuras', '4'), (NULL, 'Historia de la Magia', '4'), (NULL, 'Astronomía', '2'), (NULL, 'Transformaciones', '4'), (NULL, 'Vuelo', '4'), (NULL, 'Estudios Muggles', '3'), (NULL, 'Cuidado de Criaturas Mágicas', '3'), (NULL, 'Adivinación', '4'), (NULL, 'Runas Antiguas', '3');
INSERT INTO `asignatura` (`id_asig`, `nombre`, `creditos`) VALUES (NULL, 'Herbología', '2'), (NULL, 'Pociones', '2'), (NULL, 'Encantamientos', '2'), (NULL, 'Aritmancia', '2'), (NULL, 'Estudios Antiguos', '4'), (NULL, 'Teoría Mágica', '4') ;
