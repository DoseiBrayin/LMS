...
INSERT INTO `pensum` (`idpensum`, `nombre`,`materias`) VALUES ('8210', 'Ingenieria informatica',10), ('9192', 'Audiovisuales',10);
...
INSERT INTO `asignatura` (`id_asig`, `nombre`, `creditos`) VALUES (NULL, 'calculo diferencial', '4'), (NULL, 'algoritmos I', '4'), (NULL, 'lengua materna', '2'), (NULL, 'matematicas discretas I', '4'), (NULL, 'analisis numerico', '4'), (NULL, 'construccion de proyectos', '3'), (NULL, 'estadística', '3'), (NULL, 'fisica del movimiento', '4'), (NULL, 'calculo integral', '3');
INSERT INTO `asignatura` (`id_asig`, `nombre`, `creditos`) VALUES (NULL, 'humanidades', '2'), (NULL, 'humanidades II', '2'), (NULL, 'epistemologia', '2'), (NULL, 'audiio y video', '2'), (NULL, 'fotografia', '4'), (NULL, 'cine', '4'), (NULL, 'television', '3'), (NULL, 'gerencia audiovisual', '3');
